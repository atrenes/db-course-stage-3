...
INSERT INTO NINJA (name, clan_id, eye_id, rank_id, chakra_amount, criminal_num, criminal_group_id, is_criminal, village_id) VALUES
    ('Минато', 7, 1, 4, 800, 0, null, false, 1),
    ('Кушина', 2, 1, 3, 700, 0, null, false, 1),
    ('Наруто', 2, 1, 4, 1000, 0, null, false, 1),
    ('Саске', 3, 2, 3, 950, 32, 1, true, 1),
    ('Итачи', 3, 2, 3, 900, 182, 1, true, 1),
    ('Какаси', 4, 1, 4, 750, 0, null, false, 1),
    ('Неджи', 5, 3, 3, 680, 0, null, false, 1),
    ('Хиаши', 5, 3, 2, 700, 0, null, false, 3),
    ('Нагато', 2, 4, 3, 870, 68, 1, true, 4),
    ('Гаара', 8, 1, 4, 890, 0, null, false, 2),
    ('Обито', 3, 2, 3, 910, 59, 1, true, 1),
    ('Кисаме', 9, 1, 3, 800, 45, 3, true, 3),
    ('Забуза', 10, 1, 2, 600, 26, 3, true, 3),
    ('Чоуджуро', 1, 1, 1, 551, 13, 3, true, 3),
    ('Кушимару', 11, 1, 1, 546, 42, 3, true, 3),
    ('Орочимару', 1, 1, 3, 900, 69, null, true, 1),
    ('Мей', 12, 1, 4, 764, 0, 1, false, 3),
    ('Киллер', 12, 1, 3, 816, 1, null, false, 4),
    ('Эй', 12, 1, 4, 821, 0, 1, false, 4),
    ('Ооноки', 1, 1, 4, 879, 1, null, false, 5),
    ('Дейдара', 1, 1, 2, 764, 56, 1, true, 5),
    ('Сасори', 1, 1, 2, 648, 23, 1, true, 2),
    ('Темари', 1, 1, 1, 567, 1, null, false, 2),
    ('Канкуро', 6, 1, 3, 789, 1, null, false, 2);
...
INSERT INTO TECHNIQUE (name, type_id, clan_id, chakra_cost) VALUES
    ...
    ('Меч Кагуцучи: Ярость',3,1,232),
    ('Человеческий Снаряд Йо-Йо',2,1,241),
    ('Построение Скальной Лавины',4,1,299),
    ('Полет!',4,1,706),
    ('Шип',3,1,318),
    ('Стихия Взрыва: Минный Кулак',2,1,555),
    ('Тайдзюцу Листа: Вихрь Яростных Ударов Ног',3,1,204),
    ('Истинные Восемь Триграмм Шестьдесят Четыре Ладони',2,1,640),
    ('Всплеск Девятихвостого',2,1,503),
    ('Последняя Надежда: Атака Восьми Врат',3,1,553),
    ('Тигровая Лилия',3,1,238),
    ('Вихрь Листа',2,1,699),
    ('Сон Багрового Листа',3,1,77),
    ('Кагуцучи Расенган',3,1,204),
    ('Восемь Триграмм: Триста Шестьдесят Один Стиль',2,1,562),
    ('Танец Клематиса: Цветок',3,1,699),
    ('Пятитысячное Комбо Наруто Узумаки',3,1,694),
    ('Комбо Атака Наруто Узумаки',2,1,162),
    ('Цветочный Аромат',2,1,464),
    ('Искусство Ниндзя: Техника Прохождения Сквозь Стену',2,1,757),
    ('Сияющий Страусиный Пинок',2,1,269),
    ('Усиленная Чакрой Мощь',3,1,448);
...
INSERT INTO CRIME_TO_NINJA (ninja_id, crime_id) VALUES
    (4,68),
    (4,61),
    (4,56),
    (4,26),
