...
CREATE TABLE TECHNIQUE_TO_NINJA(
  ...
  PRIMARY KEY (NINJA_ID, TECHNIQUE_ID)
);
...
CREATE INDEX "CHAKRA_AMOUNT_IND" ON NINJA USING btree(CHAKRA_AMOUNT);
CREATE INDEX "CRIMINAL_NUM_IND" ON NINJA USING btree(CRIMINAL_NUM);